...
6. Build the Google/email sign-in page, sign-out endpoint, access-denied page, and protected board/admin route shells.
...
- Passwords for email accounts are handled only by Firebase Authentication; the app stores no password data.
