    ...
    <main className="content-page">
      <article className="card content-card">
        ...
        <section>
          ...
          <p>
            Anonymous requests do not require sign-in. Named requests require Google sign-in so the displayed name cannot be typed in by someone else.
          </p>
        </section>
        ...
        <section>
          ...
          <div className="copy-template">
            ...
            <p>
              You can submit anonymously without signing in, or sign in with Google if you want your name shown. Please only share details you have permission to share.
            </p>
          </div>
        </section>
